...
select film.film_id, film.title, film.release_year, actor.actor_id, concat_ws(" ", actor.first_name, actor.last_name) as actor
from actor
join film_actor on actor.actor_id = film_actor.actor_id
...
select actor.actor_id, concat_ws(' ', actor.first_name, actor.last_name) as actor, film.film_id, film.title, film.description, film.release_year, film.rating, film.special_features, category.name as genre
from film
